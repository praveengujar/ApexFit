...
final class WatchWorkoutManager: NSObject {
    ...
    // Internal
    private var hrSamples: [ZyvaShared.HeartRateSample] = []
    private var strainEngine: ZyvaShared.StrainEngine?
    private var zoneCalculator: ZyvaShared.HeartRateZoneCalculator?
    ...
    func configure(maxHeartRate: Int, dayStrainBefore: Double) {
        ...
        self.strainEngine = ZyvaShared.StrainEngine(
            maxHeartRate: Int32(maxHeartRate),
            strainConfig: config.strain,
            hrZoneConfig: config.heartRateZones
        )
        self.zoneCalculator = ZyvaShared.HeartRateZoneCalculator(
            maxHeartRate: Int32(maxHeartRate),
    ...
    func workoutBuilder(_ workoutBuilder: HKLiveWorkoutBuilder, didCollectDataOf collectedTypes: Set<HKSampleType>) {
        for type in collectedTypes {
            ...
            case HKQuantityType(.heartRate):
                ...
                let sample = ZyvaShared.HeartRateSample(
