...
class ProfileViewModel @Inject constructor(
    ...
    private fun loadData() {
        viewModelScope.launch {
            ...
            // Zyva Age
            val (zyvaAge, yearsYounger) = computeZyvaAge()
    ...
    private suspend fun computeZyvaAge(): Pair<Double?, Double> {
        ...
        return result.zyvaAge to result.yearsYoungerOlder
    }
