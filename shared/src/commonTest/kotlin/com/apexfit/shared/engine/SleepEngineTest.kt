...
class SleepEngineTest {
    ...
    fun classifySessions_singleSession_mainSleepNoNaps() {
        ...
        assertNotNull(main)
        assertApprox(480.0, main.totalSleepMinutes, 0.01)
        assertTrue(naps.isEmpty())
    }
    ...
    fun classifySessions_mainPlusNap_classifiesCorrectly() {
        ...
        assertApprox(45.0, naps[0].totalSleepMinutes, 0.01)
    }
    ...
    fun computeSleepNeed_highStrain_addsSupplement() {
        ...
        assertApprox(8.4, need, 0.01)
    }

    @Test
    fun computeSleepPerformance_perfectSleep_returns100() {
        assertApprox(100.0, engine.computeSleepPerformance(8.0, 8.0), 0.01)
    }

    @Test
    fun computeSleepPerformance_halfSleep_returns50() {
        assertApprox(50.0, engine.computeSleepPerformance(4.0, 8.0), 0.01)
    }
    ...
    fun computeSleepDebt_allDeficits_accumulatesDebt() {
        ...
        assertApprox(4.0, engine.computeSleepDebt(actuals, needs), 0.01)
    }
    ...
    fun computeSleepDebt_surplusIgnored() {
        ...
        assertApprox(0.0, engine.computeSleepDebt(actuals, needs), 0.01)
    }
    ...
    fun computeRestorativeSleepPct_correctRatio() {
        ...
        assertApprox(41.67, engine.computeRestorativeSleepPct(s), 0.01)
    }
    ...
    fun computeDisturbancesPerHour_correctRate() {
        ...
        assertApprox(0.5, engine.computeDisturbancesPerHour(s), 0.01)
    }
    ...
    fun computeSleepConsistency_noPriorHistory_returns100() {
        ...
        assertApprox(100.0, result, 0.01)
    }
}
