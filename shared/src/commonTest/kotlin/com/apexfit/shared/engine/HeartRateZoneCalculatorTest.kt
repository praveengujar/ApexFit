...
class HeartRateZoneCalculatorTest {
    ...
    fun multiplier_belowThreshold_returnsZero() {
        assertApprox(0.0, calculator.multiplier(80.0), 0.001)
    }
